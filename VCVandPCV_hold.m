...
global VD Do13 Dc13 Do Dc Solubility_O2 Solubility_CO2 Vpc Th L KT KR L2 h r2 AcceRate Ps Ts Tbody fo fc exHold1 exHold2

% Ventilation的所有参数，pressure单位为cmH2O 
kv1 = 0.53;             kv2  = 4.41;             k1 = 0.31;               k2 = 0.2;  
k3 = 0.2;               Vcmax = 0.1;             Ep = 10;                 Ecw = 10; 
%%kv1 = 0.53;             kv2  = 0.53;             k1 = 4.41;               k2 = 4.41;  
%%k3 = 0.31;               Vcmax = 0.2;             Ep = 9.5;                 Ecw = 47.5;  
...
% k4 = 9.5;               a = 0.35;                 b = 2;                 FRC = 2.2;     setPvent = 12.1; 
%%k4 = 47.5;                a = 1.05;                 b = 6;                  FRC = 3;      setPvent = 23.683; 
k4 = 0.31;               a = 0.2;                 b = 0.2;                 FRC = 0.2;     setPvent = 23.683; 

% Gas exchange的所有参数,pressure单位为mmHg 
...
[t_VCV,P_VCV] = ode15s(@(t,y)odeVCV_hold(t,y), [0,stop_VCV], [Pcw0_VCV Pel0_VCV Pc0_VCV]);
